...
When I will click in action on Unpublished issues tab element with css selector .nav-tabs > li:nth-child(1) > a:nth-child(1)
And I will click in action on share icon element with css selector .fa-check-circle-o
